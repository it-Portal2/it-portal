              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium text-lg">
                    {formatAmount(record.paidAmount, record.currency)}
                  </p>
                </div>
              </div>
              ...
              {record.paymentType === "installment" && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2 border-t">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {record.installmentPercentage}% of total amount
                    </p>
                  </div>
                </div>
              )}
...
const Payment = () => {
  ...
  const fetchPaymentRecords = async () => {
    setIsLoading(true);
    try {
      const result = await fetchClientPaymentRecordsAction(
        profile?.email || ""
      );
  ...
  const handleSubmitReceipt = async () => {
    ...
    if (receiptForm.paymentType === "installment") {
      if (
        !receiptForm.installmentPercentage ||
        !receiptForm.totalProjectAmount
      ) {
        toast.error(
          "Please fill installment percentage and total project amount"
        );
        return;
      }
    }
    ...
    try {
      ...
      const paymentData: PaymentFormData = {
        ...
        ...(receiptForm.paymentType === "installment" && {
          installmentPercentage: Number.parseFloat(
            receiptForm.installmentPercentage
          ),
      ...
      const result = await submitPaymentRecordAction(
        paymentData,
        "/client/payment"
      );
                      ...
                      <div>
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              copyToClipboard(paymentDetails.paypal.email)
                            }
                      ...
                      <div>
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              copyToClipboard(paymentDetails.upi.upiId)
                            }
                            className="h-6 w-6 p-0"
                          >
                            <Copy className="h-3 w-3" />
                    ...
                    <CardContent className="space-y-3">
                      <Alert className="border-orange-200 bg-orange-50">
                        ...
                        <AlertDescription className="text-xs text-orange-800">
                          <strong>For Indian Payments:</strong> Please add 18%
                          GST to the invoice amount
                        </AlertDescription>
                      </Alert>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-3">
                ...
                <RadioGroup
                  ...
                  onValueChange={(value: "full" | "installment") =>
                    handleReceiptFormChange("paymentType", value)
                  }
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleReceiptFormChange("projectName", e.target.value)
                    }
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleReceiptFormChange("currency", value)
                    }
                  >
                    <SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleReceiptFormChange("amount", e.target.value)
                      }
                      className="pl-8"
                    />
                  </div>
              ...
              {receiptForm.paymentType === "installment" && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-muted/50 rounded-lg border">
                  <div className="space-y-2">
                    <Label htmlFor="totalProjectAmount">
                      Total Project Amount *
                    </Label>
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="installmentPercentage">
                      Percentage Paying Now *
                    </Label>
                    <div className="relative">
                      <Input
              ...
              <div className="space-y-2">
                ...
                {receiptForm.receipt && (
                  <p className="text-sm text-muted-foreground">
                    Selected: {receiptForm.receipt.name}
                  </p>
                )}
              </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-muted-foreground">
                Track all your payment submissions and their status
              </p>
            </div>
            <ProjectTable
              data={paymentRecords}
